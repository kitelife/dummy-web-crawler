...
public class App {
    ...
    private void loadHandler() {
        ...
        for (String handler : handlers) {
            try {
                Class<?> ht = Class.forName(String.format("com.baidu.cloud.handler.%s", handler));
    ...
    private static InputAdapter loadAdapter(String whichAdapter) {
        ...
        try {
            Class<?> ht = Class.forName(String.format("com.baidu.cloud.adapter.%sAdapter", whichAdapter));
